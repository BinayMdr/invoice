<div class="container-fluid pb-4">
    <div class="row">
      <div class="col-12">
        <div class="input-group d-flex  justify-content-end">
          <a type="button" class="btn btn-info mx-2" href="{{route('create.branch')}}">
            ...
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <p class="text-xs font-weight-bold mb-0 px-3">{{$branch->name}}</p>
                    </td>
                    <td>
                      <p class="text-xs font-weight-bold mb-0">{{$branch->is_enabled ? 'Active' : 'Inactive'}}</p>
                    </td>
                    <td class="align-middle">
                      <a href="{{route('edit.branch',['branch' => $branch])}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                        Edit
                      </a>
                    </td>
                  </tr>
    ...
    {{ $branches->links('vendor.livewire.simple-bootstrap') }}
  </div>
