          ...
          <div class="col-12">
            <div class="card card-plain h-100">
              <div class="card-header pb-0 p-3">
                <h6 class="mb-0">@if(!is_null($customerReview)) Update customer review @else Add customer review @endif </h6>
              </div>
              <div class="card-body">
                @error('name')
                ...
                <form class="text-start" 
                  ...
                  <div class="row my-4">
                    <div class="col-6">
                        ...
                        @elseif(!is_null($customerReview))
                            <img src="{{ env('APP_URL').'storage/'.$customerReview->image }}" style="width: 30%; height: 100%;">
                        @endif
                        </div>      
                        <div>
                        <input type="file" class="form-control" name="image" wire:model.lazy="image" accept="image/*">
                        </div> 
                        <label class="form-label">Image @if(!$customerReview)<span class="text-danger">*</span> @endif </label>
                    </div>
                    <div class="col-6">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2">@if(!is_null($customerReview)) Update @else Add @endif Customer Review</button>
                  </div>
                </form>
              </div>
            </div>
