    ...
    <div class="row">
      <div class="col-12">
        <div class="input-group d-flex  justify-content-end">
          <a type="button" class="btn btn-info mx-2" href="{{route('create.customer')}}">
            ...
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <p class="text-xs font-weight-bold mb-0 px-3">{{$customer->name}}</p>
                    </td>
                    <td>
                      <p class="text-xs font-weight-bold mb-0">{{$customer->phone_number}}</p>
                    </td>
                    <td class="align-middle">
                      <a href="{{route('edit.customer',['customer' => $customer])}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                        Edit
                      </a>
                    </td>
                  </tr>
