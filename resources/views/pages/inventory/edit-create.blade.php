            ...
            <div class="col-6">
              <div class="card card-plain h-100">
                ...
                <div class="card-body">
                  ...
                  @endif
                  <form role="form" class="text-start" method="POST" @if(is_null($inventory)) action="{{route('store.inventory')}}" @else action="{{route('update.inventory',['product'=>$product->id])}}" @endif>
                    @csrf
                    ...
                    <div class="input-group input-group-outline my-3 @if(!is_null($inventory)) is-filled @endif">
                      ...
                      <input type="number" class="form-control" name="total" required value="{{ $product->total ?? ""}}" autocomplete="off">
                    </div>
